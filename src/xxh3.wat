...
;; accumulate(acc, input, secret, nbStripes):
;;   for (i32 n = 0; n < nbStripes; n++) {
;;     accumulate_512(
;;       acc, 
;;       i32.add(input, i32.shl(n, 6)), 
;;       i32.add(secret, i32.shl(n, 3))
;;     )
;;   }
(func $accumulate (param $acc i32) (param $input i32) (param $secret i32) (param $nbStripes i32)
  (local $n i32)
  (local.set $n (i32.const 0))
  (if (i32.lt_u (local.get $n) (local.get $nbStripes)) 
    (loop $l
      (call $accumulate_512
        (local.get $acc)
        (i32.add (local.get $input) (i32.shl (local.get $n) (i32.const 6)))
        (i32.add (local.get $secret) (i32.shl (local.get $n) (i32.const 3))))
      (local.set $n (i32.add (local.get $n) (i32.const 1)))
      (br_if $l (i32.lt_u (local.get $n) (local.get $nbStripes)))
      )))

;; TODO: unroll this loop?
;; accumulate_512(acc, input, secret):
;; 	for (i32 i = 0; i < 4; i++) {
;; 		data_vec = v128.load(i32.add(input, i32.shl(i, 4)))
;; 		data_key = v128.xor(data_vec, v128.load(i32.add(secret, i32.shl(i, 4))))
;; 
;; 		// TODO: Which of theses is faster?
;; 		// data_key_hi = i8x16.swizzle(data_key, v128.const(i32x4, 0, 3, 0, 1))
;; 		data_key_hi = i64x2.shr_u(data_key, i32.const(32))
;; 
;; 		offset = i32.add(acc, i32.shl(i, 3))
;; 		v128.store(
;; 			offset,
;; 			i64x2.add(
...
(func $accumulate_512 (param $acc i32) (param $input i32) (param $secret i32)
  ...
  (loop $l
    (local.set $data_vec (v128.load (i32.add (local.get $input) (i32.shl (local.get $i) (i32.const 4)))))
    (local.set $data_key (v128.xor (local.get $data_vec) (v128.load (i32.add (local.get $secret) (i32.shl (local.get $i) (i32.const 4))))))
    (local.set $data_key_hi (i64x2.shr_u (local.get $data_key) (i32.const 32)))
    (local.set $data_key_lo (v128.and (local.get $data_key) (v128.const i64x2 0x00000000FFFFFFFF 0x00000000FFFFFFFF)))
    (local.set $offset (i32.add (local.get $acc) (i32.shl (local.get $i) (i32.const 4))))
    (v128.store
      (local.get $offset) 
      (i64x2.add 
        ...
        (i64x2.add 
          ...
          (i8x16.swizzle (local.get $data_vec) (v128.const i8x16 8 9 10 11 12 13 14 15 0 1 2 3 4 5 6 7)))))
    (local.set $i (i32.add (local.get $i) (i32.const 1)))
    (br_if $l (i32.lt_u (local.get $i) (i32.const 4)))))

;; TODO: unroll this?
;; scrambleAcc(acc, secret):
;; 	prime32 = i32x4.splat(iXXH_PRIME32_1)
;; 	for (i32 i = 0; i < 4; i++) {
;; 		offset = i32.add(acc, i32.shl(i, 4))
;; 		lane = v128.load(offset)
;; 		v128.store(
;; 			offset,
;; 			i64x2.mul(
;; 				v128.xor(
;; 					v128.xor(lane, i64x2.shr_u(lane, 47)),
;; 					v128.load(i32.add(secret, i32.shl(i, 4)))
;; 				),
;; 				prime32
;; 			)
;; 		)
;; 	}
(func $scrambleAcc (param $acc i32) (param $secret i32)
  (local $prime32 v128)
  (local $offset i32)
  (local $lane v128)
  (local $i i32)
  (local.set $i (i32.const 0))
  ;; (local.set $prime32 (i32x4.splat (global.get $PRIME32_1)))
  (local.set $prime32 (i64x2.splat (i64.extend_i32_u (global.get $PRIME32_1))))
  (loop $l
    (local.set $offset (i32.add (local.get $acc) (i32.shl (local.get $i) (i32.const 4))))
    (local.set $lane (v128.load (local.get $offset)))
    (v128.store (local.get $offset) 
      (i64x2.mul 
        (v128.xor 
          (v128.xor 
            (local.get $lane) 
            (i64x2.shr_u (local.get $lane) (i32.const 47)))
          (v128.load 
...
;; 	nbStripesPerBlock = i32.shr_s(i32.sub(secretSize, 64), 3) // 16
;; 	block_len = i32.shl(nbStripesPerBlock, 6) // 1024
;; 	nb_blocks = i32.div_u(i32.sub(len, 1), block_len) 
;; 
;; 	for (i32 n = 0; n < nb_blocks; n++) {
;; 		accumulate(acc, i32.add(input, i32.mul(n, block_len)), secret, nbStripesPerBlock)
;; 		scrambleAcc(acc, i32.sub(i32.add(secret, secretSize), 64))
;; 	}
;; 
;; 	accumulate(acc, i32.add(input, i32.mul(nb_blocks, block_len)), secret, i32.shr_u(i32.sub(i32.sub(len, 1), i32.mul(block_len, nb_blocks)), 6))
;; 	accumulate_512(acc, i32.sub(i32.add(input, len), 64), i32.sub(i32.add(secret, secretSize), 57)
(func $XXH3_hashLong_internal_loop (param $acc i32) (param $input i32) (param $len i32) (param $secret i32) (param $secretSize i32)
  ...
  (call $accumulate_512
    ...
    (i32.sub (i32.add (local.get $secret) (local.get $secretSize)) (i32.const 71))))
...
;; TODO: unroll this?
;; XXH3_mergeAccs(acc, secret, start):
;; 	result64 = start
;; 	for (i32 i = 0; i < 4; i++) {
;; 		offset = i32.add(acc, i32.shl(i, 4))
;; 		result64 = i64.add(
;; 			result64,
;; 			XXH3_mul128_fold64(
;; 				i64.xor(i64.load(offset), i64.load(i32.add(secret, i32.shl(i, 5)))),
;; 				i64.xor(i64.load(i32.add(offset, 8)), i64.load(i32.add(secret, i32.add(i32.shl(i, 5), 8))))
;; 			)
;; 		)
;; 	}
;; 
;; 	return XXH3_avalanche(result64)
(func $XXH3_mergeAccs (param $acc i32) (param $secret i32) (param $start i64) (result i64)
  (local $result64 i64)
  (local $offset i32)
  (local $i i32)
  (local.set $result64 (local.get $start))
  (local.set $i (i32.const 0))
  (loop $l
    (local.set $offset (i32.add (local.get $acc) (i32.shl (local.get $i) (i32.const 4))))
    (local.set $result64 
            ...
            (else 
              (if (i64.eq (local.get $seed) (i64.const 0))
                ...
                (else
                  ;; TODO
                  nop))
              (local.set $acc (local.get $secretSize))
              ;; (memory.init 1 (local.get $acc) (i32.const 0) (i32.const 64))
              ;; TODO: We should memory.init this instead of 8 ops.
              (i64.store (local.get $acc) (i64.extend_i32_u (global.get $PRIME32_3)) align=4)
              (i64.store (i32.add (local.get $acc) (i32.const 8)) (global.get $PRIME64_1) align=4)
              (i64.store (i32.add (local.get $acc) (i32.const 16)) (global.get $PRIME64_2) align=4)
              (i64.store (i32.add (local.get $acc) (i32.const 24)) (global.get $PRIME64_3) align=4)
              (i64.store (i32.add (local.get $acc) (i32.const 32)) (global.get $PRIME64_4) align=4)
              (i64.store (i32.add (local.get $acc) (i32.const 40)) (i64.extend_i32_u (global.get $PRIME32_2)) align=4)
              (i64.store (i32.add (local.get $acc) (i32.const 48)) (global.get $PRIME64_5) align=4)
              (i64.store (i32.add (local.get $acc) (i32.const 56)) (i64.extend_i32_u (global.get $PRIME32_1)) align=4)

              (call $XXH3_hashLong_internal_loop 
                (local.get $acc) 
                (local.get $input) 
                (local.get $len) 
                (local.get $secret) 
                (local.get $secretSize))
              (call $XXH3_mergeAccs
                (local.get $acc)
                (i32.add (local.get $secret) (i32.const 11))
...
;; 		)
;; 	)
(func $XXH3_mix16B (param $input i32) (param $secret i32) (param $seed64 i64) (result i64)
  (call $XXH3_mul128_fold64
    (i64.xor (i64.load (local.get $input)) (i64.add (i64.load (local.get $secret)) (local.get $seed64)))
    (i64.xor 
      (i64.load (i32.add (local.get $input) (i32.const 8))) 
      (i64.sub (i64.load (i32.add (local.get $secret) (i32.const 8))) (local.get $seed64)))))
            ...
            (else
              (call $XXH64_avalanche 
                (i64.xor 
                  (local.get $seed) 
                  (i64.xor 
                    (i64.load (i32.add (local.get $secret) (i32.const 56)))
                    (i64.load (i32.add (local.get $secret) (i32.const 64)))))))))))))
...
(func $XXH3_len_1to3_64b (param $input i32) (param $len i32) (param $secret i32) (param $seed i64) (result i64)
  (call $XXH64_avalanche
    (i64.xor
      ...
      (i64.add
        (i64.extend_i32_u (i32.xor (i32.load (local.get $secret)) (i32.load (i32.add (local.get $secret) (i32.const 4)))))
        (local.get $seed)))))
...
(func $XXH3_len_4to8_64b (param $input i32) (param $len i32) (param $secret i32) (param $seed i64) (result i64)
  (call $XXH3_rrmxmx
    (i64.xor
      ...
      (i64.sub
        (i64.xor (i64.load (i32.add (local.get $secret) (i32.const 8))) (i64.load (i32.add (local.get $secret) (i32.const 16))))
...
(func $XXH3_len_9to16_64b (param $input i32) (param $len i32) (param $secret i32) (param $seed i64) (result i64)
  ...
  (local.set $input_lo 
    (i64.xor 
      ...
      (i64.add 
        (i64.xor
          (i64.load (i32.add (local.get $secret) (i32.const 24)))
          (i64.load (i32.add (local.get $secret) (i32.const 32))))
        (local.get $seed))))
  (local.set $input_hi
    (i64.xor 
      ...
      (i64.sub 
        (i64.xor
          (i64.load (i32.add (local.get $secret) (i32.const 40)))
          (i64.load (i32.add (local.get $secret) (i32.const 48))))
        (local.get $seed))))
  (call $XXH3_avalanche 
    (i64.add 
      (i64.extend_i32_u (local.get $len))
